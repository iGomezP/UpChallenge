...
{
    internal sealed class RejectTransactionDomainEventHandler : INotificationHandler<TransactionRejectedDomainEvent>
    {
        ...
        public RejectTransactionDomainEventHandler(
        ...
        public async Task Handle(TransactionRejectedDomainEvent notification, CancellationToken cancellationToken)
        {
            ...
            await _emailService.SendMailAsync(
                ...
                $"Your transaction with reference {transaction.MovReference} has been rejected."
            );
        }
    }
}
