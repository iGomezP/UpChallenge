...
{
    internal sealed class FailTransactionDomainEventHandler : INotificationHandler<TransactionFailedDomainEvent>
    {
        ...
        public FailTransactionDomainEventHandler(
        ...
        public async Task Handle(TransactionFailedDomainEvent notification, CancellationToken cancellationToken)
        {
            ...
            await _emailService.SendMailAsync(
                ...
                $"Transaction Failed",
                $"Your transaction with reference {transaction.MovReference} has failed."
            );
        }
    }
}
